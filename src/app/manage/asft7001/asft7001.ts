...
@Component({
  standalone: true,
  selector: 'app-asft7001',
  imports: [ScanModal, FormsModule],
  templateUrl: './asft7001.html',
  styleUrl: './asft7001.scss',
})

export class Asft7001 implements OnInit, AfterViewInit {
  table: any
  pageLength = 50
  inputA01?: string
  inputA02?: string
