...
@Component({
  standalone: true,
  selector: 'app-csfi5143',
  imports: [ScanModal, FormsModule],
  templateUrl: './csfi5143.html',
  styleUrl: './csfi5143.scss',
})

export class Csfi5143 implements OnInit, AfterViewInit {
  table: any
  pageLength = 50
  inputA01?: string
  inputA02?: string
  ...
  init_table() {
    ...
    this.table = $(this.tableRef.nativeElement).DataTable({
      ...
      columns: [
        ...
        {
          data: '', 'title': '發料單號<br />製造批號<br />布疋號<br />料號',
          render: function (data: any, type: any, row: any, meta: any) {

          }
        },
        {
          data: '', 'title': '來源載體<br />儲位',
          render: function (data: any, type: any, row: any, meta: any) {
