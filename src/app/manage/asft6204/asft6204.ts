...
@Component({
  standalone: true,
  selector: 'app-asft6204',
  imports: [ScanModal, FormsModule],
  templateUrl: './asft6204.html',
  styleUrl: './asft6204.scss',
})

export class Asft6204 implements OnInit, AfterViewInit {
  table: any
  pageLength = 50
  inputA01?: string
  inputA02?: string
  ...
  init_table() {
    ...
    this.table = $(this.tableRef.nativeElement).DataTable({
      ...
      columns: [
        ...
        {
          data: '', 'title': '入庫單號<br />製造批號<br />料號',
          render: function (data: any, type: any, row: any, meta: any) {

          }
        },
        {
          data: '', 'title': '載體<br />倉庫<br />儲位',
          render: function (data: any, type: any, row: any, meta: any) {
